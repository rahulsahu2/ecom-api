            ...
            <div class="row mt-4">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                        @if ($shopconcern)
                            <form action="{{ route('admin.best-seller-banners.update',$shopconcern->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
...
​
                        ...
                        @else
                            <form action="{{ route('admin.best-seller-banners.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="form-group col-6">
                                        <label for="">{{__('admin.New Image')}}</label>
