...
​
          ...
          <a href="{{ route('admin.category-list.index') }}" class="btn btn-primary"><i class="fas fa-list"></i> {{__('Category Lists')}}</a>
            <div class="row mt-4">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                        @if ($brandBanners)
                            <form action="{{ route('admin.category-list.update',$brandBanners->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
