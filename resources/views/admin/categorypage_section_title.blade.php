...
@section('title')
<title>{{__('admin.BrandPage Section Title')}}</title>
@endsection
      ...
      <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>{{__('CategoryPage Section Title')}}</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active">
                        <a href="{{ route('admin.dashboard') }}">{{__('admin.Dashboard')}}</a>
                    </div>
                    <div class="breadcrumb-item">{{__('Categorypage Section Title')}}</div>
                </div>
            </div>
            ...
            <div class="section-body">
                <div class="row mt-4">
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('admin.update-categorypage-section-title') }}" method="post">
                                    @csrf
