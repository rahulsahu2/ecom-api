...
​
          ...
          <a href="{{ route('admin.lux-best-sellers.index') }}" class="btn btn-primary"><i class="fas fa-list"></i> {{__('Best Sellerss')}}</a>
            <div class="row mt-4">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                        @if ($brandBanners)
                            <form action="{{ route('admin.lux-best-sellers.update',$brandBanners->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">​
​
                        ...
                        @else
                            <form action="{{ route('admin.lux-best-sellers.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    ​
                                    ​<div class="form-group col-12">
