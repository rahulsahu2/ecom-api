        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">{{__('Top Picks')}}</div>
            </div>
          </div>

          <div class="section-body">
            <a href="{{ route('admin.create-lux-top-picks') }}" class="btn btn-primary"><i class="fas fa-plus"></i> {{__('admin.Add New')}}</a>
            <div class="row mt-4">
                <div class="col">
                  <div class="card">
                    <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($shopconcern as $index => $service)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.show-lux-top-picks',$service->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit" aria-hidden="true"></i></a>
...
<script>
    function deleteData(id){
        $("#deleteForm").attr("action",'{{ url("admin/delete-lux-top-picks/") }}'+"/"+id)
    }
    function changeStatus(id){
        $.ajax({
            type:"put",
            data: { _token : '{{ csrf_token() }}' },
            url:"{{url('/admin/lux-top-picks-status')}}"+"/"+id,
