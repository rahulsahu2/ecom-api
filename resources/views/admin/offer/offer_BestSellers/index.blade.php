      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <a href="{{ route('admin.create-offer-best-sellers') }}" class="btn btn-primary"><i class="fas fa-plus"></i> {{__('admin.Add New')}}</a>
            <div class="row mt-4">
                <div class="col">
                  <div class="card">
                    <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($brandBanners as $index => $service)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.show-offer-best-sellers',$service->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit" aria-hidden="true"></i></a>
...
<script>
    function deleteData(id){
        $("#deleteForm").attr("action",'{{ url("admin/delete-offer-best-sellers/") }}'+"/"+id)
    }
    function changeStatus(id){
        $.ajax({
            type:"put",
            data: { _token : '{{ csrf_token() }}' },
            url:"{{url('/admin/offer-best-sellers-status')}}"+"/"+id,
