...
​
          ...
          <a href="{{ route('admin.offer-slider.index') }}" class="btn btn-primary"><i class="fas fa-list"></i> {{__('Sliders')}}</a>
            <div class="row mt-4">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                        @if ($shopconcern)
                            <form action="{{ route('admin.offer-slider.update',$shopconcern->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                        ...
                        @else
                            <form action="{{ route('admin.offer-slider.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="form-group col-6">
                                        <label for="">{{__('admin.New Image')}}</label>
