...
​
          ...
          <a href="{{ route('admin.product-description.index') }}" class="btn btn-primary"><i class="fas fa-list"></i> {{__('Product Descriptions')}}</a>
            <div class="row mt-4">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                        @if ($shopconcern)
                            <form action="{{ route('admin.product-description.update',$shopconcern->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
