        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">{{__('TopBrands')}}</div>
            </div>
          </div>

          <div class="section-body">
            <a href="{{ route('admin.create-top-brands') }}" class="btn btn-primary"><i class="fas fa-plus"></i> {{__('admin.Add New')}}</a>
            <div class="row mt-4">
                <div class="col">
                  <div class="card">
                    <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($shopconcern as $index => $service)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.show-top-brands',$service->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit" aria-hidden="true"></i></a>
...
<script>
    ...
    function changeStatus(id){
        $.ajax({
            ...
            url:"{{url('/admin/top-brands-status')}}"+"/"+id,
