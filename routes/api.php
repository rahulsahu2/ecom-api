...
Route::group([], function () {
    ...
    Route::get('/featured-product', [HomeController::class, 'featured_product'])->name('featured-product');
    Route::get('/new-product', [HomeController::class, 'new_product'])->name('new-product');
    ...
    Route::get('/products-review-list', [HomeController::class, 'productsReviewList'])->name('products-review-list');
